 ...
 * @type {validator}
 */
const validFacetime = (link, options, callback) => {
 ...
 * @type {validator}
 */
const validMailto = (link, options, callback) => {
 ...
 * @type {validator}
 */
const validSms = (link, options, callback) => {
 ...
 * @type {validator}
 */
const validTel = (link, options, callback) => {
